...
var Controller = function (_MeasueMobileBaseCont) {
  ...
  _proto.init = function init() {
    ...
    _MeasueMobileBaseCont.prototype.init.call(this, this);
  };
...
var _default = function (_olInteractionInterac) {
  ...
  function _default(options) {
    ...
    ol_events_js__WEBPACK_IMPORTED_MODULE_2__["listen"](_assertThisInitialized(_assertThisInitialized(_this)), 'change:active', _this.updateState_, _assertThisInitialized(_assertThisInitialized(_this)));
  ...
  _proto.addToDrawing = function addToDrawing() {
    ...
    if (this.type_ === 'Point') {
      ...
      console.assert(sketchFeatureGeom instanceof ol_geom_SimpleGeometry_js__WEBPACK_IMPORTED_MODULE_8__["default"]);
    ...
    if (this.type_ === 'Polygon') {
      ...
      if (!this.sketchFeature_) {
        ...
        sketchFeatureGeom = this.sketchFeature_.getGeometry();
        console.assert(sketchFeatureGeom instanceof ol_geom_Polygon_js__WEBPACK_IMPORTED_MODULE_7__["default"]);
  ...
  _proto.modifyDrawing_ = function modifyDrawing_() {
    ...
    if (this.type_ === 'LineString') {
      ...
      console.assert(_sketchFeatureGeom instanceof ol_geom_Polygon_js__WEBPACK_IMPORTED_MODULE_7__["default"]);
  ...
  _proto.getSketchPointGeometry_ = function getSketchPointGeometry_() {
    ...
    console.assert(geometry instanceof ol_geom_Point_js__WEBPACK_IMPORTED_MODULE_6__["default"]);
    return geometry;
  };
