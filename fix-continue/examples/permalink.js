...
MapComponentController.prototype.$onInit = function () {
  ...
  var zoom = this.ngeoLocation_.getParam('z');
...
DrawComponentController.prototype.$onInit = function () {
  ...
  Object(ngeo_misc_decorate_js__WEBPACK_IMPORTED_MODULE_5__["interaction"])(this.interaction);
...
/* harmony import */ var ol_color_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ol/color.js */ "./node_modules/ol/color.js");
...
var _default = function (_olFormatTextFeature) {
  ...
  _proto.writeGeometryText = function writeGeometryText(geometry, opt_options) {
    ...
    var transformedGeometry = ol_format_Feature_js__WEBPACK_IMPORTED_MODULE_5__["transformWithOptions"](geometry, true, opt_options);
...
function encodeStyleFill_(fillStyle, encodedStyles, opt_propertyName) {
  ...
  if (fillColor !== null) {
    ...
    var fillColorRgba = ol_color_js__WEBPACK_IMPORTED_MODULE_4__["asArray"](fillColor);
    console.assert(Array.isArray(fillColorRgba), 'fill color must be an array');
    var fillColorHex = Object(ngeo_utils_js__WEBPACK_IMPORTED_MODULE_2__["rgbArrayToHex"])(fillColorRgba);
...
function encodeStyleStroke_(strokeStyle, encodedStyles) {
  ...
  if (strokeColor !== null) {
    ...
    var strokeColorRgba = ol_color_js__WEBPACK_IMPORTED_MODULE_4__["asArray"](strokeColor);
    console.assert(Array.isArray(strokeColorRgba), 'only supporting stroke colors');
    var strokeColorHex = Object(ngeo_utils_js__WEBPACK_IMPORTED_MODULE_2__["rgbArrayToHex"])(strokeColorRgba);
...
function setStyleInFeature_(text, feature) {
  ...
  if (pointRadius !== undefined) {
    imageStyle = new ol_style_Circle_js__WEBPACK_IMPORTED_MODULE_14__["default"]({
      radius: pointRadius,
      fill: fillStyle,
      stroke: strokeStyle
    });
  ...
  var style = new ol_style_Style_js__WEBPACK_IMPORTED_MODULE_17__["default"]({
    fill: fillStyle,
    image: imageStyle,
    stroke: strokeStyle,
    text: textStyle
...
function writeLineStringGeometry_(geometry) {
  console.assert(geometry instanceof ol_geom_LineString_js__WEBPACK_IMPORTED_MODULE_8__["default"]);
...
function writeMultiLineStringGeometry_(geometry) {
  console.assert(geometry instanceof ol_geom_MultiLineString_js__WEBPACK_IMPORTED_MODULE_9__["default"]);
...
function writePointGeometry_(geometry) {
  console.assert(geometry instanceof ol_geom_Point_js__WEBPACK_IMPORTED_MODULE_12__["default"]);
  var flatCoordinates = geometry.getFlatCoordinates();
  var stride = geometry.getStride();
  var end = flatCoordinates.length;
...
function writeMultiPointGeometry_(geometry) {
  console.assert(geometry instanceof ol_geom_MultiPoint_js__WEBPACK_IMPORTED_MODULE_10__["default"]);
  var flatCoordinates = geometry.getFlatCoordinates();
  var stride = geometry.getStride();
  var end = flatCoordinates.length;
  return "P(" + this.encodeCoordinates_(flatCoordinates, stride, 0, end) + ")";
...
function writePolygonGeometry_(geometry) {
  console.assert(geometry instanceof ol_geom_Polygon_js__WEBPACK_IMPORTED_MODULE_13__["default"]);
  var flatCoordinates = geometry.getFlatCoordinates();
  var stride = geometry.getStride();
  var ends = geometry.getEnds();
  var offset = 0;
...
function writeMultiPolygonGeometry_(geometry) {
  console.assert(geometry instanceof ol_geom_MultiPolygon_js__WEBPACK_IMPORTED_MODULE_11__["default"]);
  var flatCoordinates = geometry.getFlatCoordinates();
  var stride = geometry.getStride();
