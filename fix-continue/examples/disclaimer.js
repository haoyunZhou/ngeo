...
MainController.prototype.inMap = function () {
  this.inMapMsgs_.forEach(function (message) {
    this.disclaimer.alert({
      msg: message,
      target: angular__WEBPACK_IMPORTED_MODULE_2___default.a.element('#disclaimers-in-map'),
...
var Disclaimer = function (_ngeoMessageMessage) {
  Disclaimer.$inject = ["$sce", "gettextCatalog", "ngeoCreatePopup"];

  _inheritsLoose(Disclaimer, _ngeoMessageMessage);
  ...
  function Disclaimer($sce, gettextCatalog, ngeoCreatePopup) {
    ...
    ngeo_message_Message_js__WEBPACK_IMPORTED_MODULE_3__["default"].call(_assertThisInitialized(_assertThisInitialized(_this)));
